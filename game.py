...
class BonusItem:
    """
    Classe pour gérer les objets bonus dans le jeu.
    """
    ...
    def trigger_bonus(self, unit):
        ...
        bonus_points = 2  # L'unité gagne 2 point de vie
        ...
        if new_health >= health_max:
            ...
            print(f"{unit.team} unit's health is now at max value: {unit.health}.")
        else:
            unit.health = new_health  # Mettre à jour la santé avec le bonus
            print(f"{unit.team} unit at ({unit.x}, {unit.y}) collected a health bonus!")
...
class Game:
    ...
    def __init__(self, screen):
        ...
        self.bonus = BonusItem('assets/star.jpg', 'assets/star_sound.mp3')
        ...
        self.bonus.generate_bonus(GRID_SIZE, num_bonus=5, obstacles=self.obstacles.positions, valid_positions=self.valid_positions)
